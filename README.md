...
After the ETL finishes, you can access the database in your DB tool of choice, like DBVisualiser, DBeaver etc. The database will run on port 1433 by default and has the following user credentials that **should be changed**:  
...
If you plan to use external files as data sources in your project, include them in the `etl/Dockerfile` or create a named volume in the dockercompose configuration.
